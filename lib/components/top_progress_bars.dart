...
class TopProgressLineBeginning extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      width:
          ((size.width - (size.width / 7)) / 3) * 1, //the 1 is for the length
      height: 5,
...
class TopProgressLineMiddle extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      width:
          ((size.width - (size.width / 7)) / 3) * 2, //the 2 is for the length
      height: 5,
      decoration: BoxDecoration(
        borderRadius: BorderRadius.circular(8),
        color: Colors.amber,
...
class TopProgressLineCompleted extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      width:
          ((size.width - (size.width / 7)) / 3) * 3, //the 2 is for the length
      height: 5,
      decoration: BoxDecoration(
        borderRadius: BorderRadius.circular(8),
        color: Colors.amber,
